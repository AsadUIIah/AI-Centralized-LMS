...
from . import views
from .views import groq_chatbot
from .views import course_recommendations
from .views import smart_job_recommendations
...
urlpatterns = [
    ...
    path('groq-chatbot/', groq_chatbot, name='groq_chatbot'),
    path('course-recommendations/', course_recommendations, name='course_recommendations'),
    path('smart-job-recommendations/', smart_job_recommendations, name='smart_job_recommendations'),
]
