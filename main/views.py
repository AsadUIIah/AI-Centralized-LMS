...
@csrf_exempt
def smart_job_recommendations(request):
    if request.method == "POST":
        data = json.loads(request.body)
...
def get_real_time_jobs(keywords, location):
    ...
    try:
        ...
        params = {
            ...
            "results_per_page": 15,
            "what": keywords if keywords else "software developer",
            "where": location if location else "United States",
        ...
        jobs = []
        if 'results' in data:
            for job in data['results'][:10]:  # Limit to 10 jobs
                job_info = {
        ...
        # Fallback: Return sample jobs if API fails
        return get_fallback_jobs(keywords, location)

def get_fallback_jobs(keywords, location):
    ...
    return [
        {
            ...
            "description": "Looking for a skilled developer with experience in modern technologies...",
            "salary_min": "60000",
            "salary_max": "90000",
            "category": "Technology",
            "url": "#"
        },
        {
            ...
            "description": "Seeking a data analyst to help with business intelligence and reporting...",
            "salary_min": "50000",
            "salary_max": "75000",
            "category": "Analytics",
            "url": "#"
